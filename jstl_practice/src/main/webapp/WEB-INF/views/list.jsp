...
<%--
	...
	Controller에서 reqeust.setAttribute("memberList", list)로 넘긴 데이터를
...
<body>
	...
	--%>
	<p>
		<a href="${pageContext.request.contextPath}/member/insertForm.html">+
			회원 등록</a>
	</p>
	...
	<table border="1" cellpadding="8">
		...
		<tbody>
			...
			<%-- 
				...
				items="배열/리스트" : 반복해서 값을 꺼내올 배열/리스트
